    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if isLogin == true {
            ...
            case 1:
                ...
                case 0:
                    let vc = UIStoryboard.init(name: "Profile", bundle: nil).instantiateViewController(withIdentifier: "EmptyVC")
                ...
                case 2:
                    addSliderView()
                case 3:
                    let vc = UIStoryboard.init(name: "Profile", bundle: nil).instantiateViewController(withIdentifier: "SettingsVC")
                    self.navigationController?.pushViewController(vc, animated: true)
                default: break
                }
            case 2:
                let vc = UIStoryboard.init(name: "Profile", bundle: nil).instantiateViewController(withIdentifier: "ReportVC")
                self.navigationController?.pushViewController(vc, animated: true)
            default: break
            }
        } else {
